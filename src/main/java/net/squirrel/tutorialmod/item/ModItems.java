...
import net.squirrel.tutorialmod.item.custom.FuelItem;
import net.squirrel.tutorialmod.item.custom.MetalDetectorItem;
import net.squirrel.tutorialmod.item.custom.ModArmorItem;
