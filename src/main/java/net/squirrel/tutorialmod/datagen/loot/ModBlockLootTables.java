package net.squirrel.tutorialmod.datagen.loot;
...
import net.squirrel.tutorialmod.block.custom.StrawberryCropBlock;
import net.squirrel.tutorialmod.item.ModItems;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        LootItemCondition.Builder lootitemcondition$builder = LootItemBlockStatePropertyCondition.hasBlockStateProperties(ModBlocks.STRAWBERRY_CROP.get()).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(StrawberryCropBlock.AGE, 5));
